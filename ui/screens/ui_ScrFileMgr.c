...
void ui_ScrFileMgr_screen_init(void)
{
    ...
    lv_obj_set_width(ui_comp_get_child(ui_year, UI_COMP_DATEITEM_NUM), 60);
    ...
    lv_obj_set_width(ui_comp_get_child(ui_month, UI_COMP_DATEITEM_NUM), 60);
    ...
    lv_obj_set_width(ui_comp_get_child(ui_day, UI_COMP_DATEITEM_NUM), 60);
    ...
    lv_obj_set_width(ui_comp_get_child(ui_hour, UI_COMP_DATEITEM_NUM), 60);
    ...
    lv_obj_set_width(ui_comp_get_child(ui_min, UI_COMP_DATEITEM_NUM), 60);
    ...
    lv_obj_set_height(ui_BTN2, 36);
    lv_obj_set_align(ui_BTN2, LV_ALIGN_TOP_RIGHT);
    lv_obj_set_x(ui_BTN2, -194);
    lv_obj_set_y(ui_BTN2, 52);

    lv_label_set_text(ui_comp_get_child(ui_BTN2, UI_COMP_BTN_BTNL), "Playback Mode");

    ui_BTN3 = ui_BTN_create(ui_ScrFileMgr);
    lv_obj_set_width(ui_BTN3, 170);
    lv_obj_set_height(ui_BTN3, 36);
    lv_obj_set_align(ui_BTN3, LV_ALIGN_TOP_RIGHT);
    lv_obj_set_x(ui_BTN3, -14);
    lv_obj_set_y(ui_BTN3, 52);

    lv_label_set_text(ui_comp_get_child(ui_BTN3, UI_COMP_BTN_BTNL), "Deletion Mode");

    ui_List_Container = lv_obj_create(ui_ScrFileMgr);
    lv_obj_set_width(ui_List_Container, 928);
    lv_obj_set_align(ui_List_Container, LV_ALIGN_TOP_MID);
    lv_obj_set_y(ui_List_Container, 104);
    ...
    lv_obj_set_width(ui_List_Header, 928);
    ...
    lv_obj_set_width(ui_List_Header_Item1, 300);
    lv_obj_set_height(ui_List_Header_Item1, LV_SIZE_CONTENT);
    lv_label_set_text(ui_List_Header_Item1, "Name");
    ...
    lv_obj_set_width(ui_List_Header_Item2, 199);
    lv_obj_set_height(ui_List_Header_Item2, LV_SIZE_CONTENT);
    lv_label_set_text(ui_List_Header_Item2, "Size");
    ...
    lv_obj_set_width(ui_List_Header_Item3, 220);
    lv_obj_set_height(ui_List_Header_Item3, LV_SIZE_CONTENT);
    lv_label_set_text(ui_List_Header_Item3, "Duration");
    ...
    lv_obj_set_width(ui_List_Header_Item4, 209);
    lv_obj_set_height(ui_List_Header_Item4, LV_SIZE_CONTENT);
    lv_label_set_text(ui_List_Header_Item4, "Time");
    ...
    lv_obj_set_x(ui_DOWNLIST, -16);
    lv_obj_set_y(ui_DOWNLIST, -74);
    ...
    lv_obj_set_width(ui_BTN4, 100);
    lv_label_set_text(ui_comp_get_child(ui_BTN4, UI_COMP_BTN_BTNL), "Back");

    ui_BTN5 = ui_BTN_create(ui_DOWNLIST);
    lv_obj_set_width(ui_BTN5, 170);
    lv_obj_set_height(ui_BTN5, 36);
    lv_label_set_text(ui_comp_get_child(ui_BTN5, UI_COMP_BTN_BTNL), "Previous Page");

    ui_BTN7 = ui_BTN_create(ui_DOWNLIST);
    lv_label_set_text(ui_comp_get_child(ui_BTN7, UI_COMP_BTN_BTNL), "1/1");

    ui_BTN6 = ui_BTN_create(ui_DOWNLIST);
    lv_obj_set_width(ui_BTN6, 170);
    lv_obj_set_height(ui_BTN6, 36);
    lv_label_set_text(ui_comp_get_child(ui_BTN6, UI_COMP_BTN_BTNL), "Next Page");
}
