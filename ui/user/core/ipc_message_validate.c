...
typedef struct {
    ROE_SL firstType;
    ROE_SL endType;
} IpcMessageTypeRange_st;

static const IpcMessageTypeRange_st g_requestResponseTypeRanges[] = {
...
static const IpcMessageTypeRange_st g_notificationTypeRanges[] = {
...
static int message_type_in_ranges(ROE_SL msgType,
                                  const IpcMessageTypeRange_st * ranges,
                                  ROE_SIZE rangeCount)
{
